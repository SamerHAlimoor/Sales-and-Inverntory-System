<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <img src="" alt="" class="brand-image img-circle elevation-3"
     style="opacity: .8">
  <span class="brand-text font-weight-light"> Sales and Inverntory System</span>
  </a>
  <!-- Sidebar -->
  <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
           ...
           <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('admin/collect_transaction*') )?'active':'' }}">
                       <p>
                          شاشة تحصيل النقدية         
                       </p>
                    </a>
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('admin/exchange_transaction*') )?'active':'' }}">
                       <p>
                          شاشة صرف النقدية         
                       </p>
                    </a>
           ...
           <li class="nav-item has-treeview {{ (request()->is('admin/suppliers_orders*') ||request()->is('admin/suppliers_orders_general_return*') ||request()->is('admin/itemcardBalance*'))?'menu-open':'' }}     ">
              ...
              <ul class="nav nav-treeview">
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('admin/suppliers_orders_general_return*')  )?'active':'' }}">
                       <p>
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('admin/itemcardBalance*')  )?'active':'' }}">
                       <p>
                          أرصدة الأصناف        
                       </p>
                    </a>
           ...
           <li class="nav-item has-treeview {{ (request()->is('admin/SalesInvoices*') || request()->is('admin/SalesReturnInvoices*'))?'menu-open':'' }}     ">
              ...
              <ul class="nav nav-treeview">
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link {{ (request()->is('admin/SalesReturnInvoices*') )?'active':'' }}">
                       <p>
           ...
           <li class="nav-item has-treeview  {{ (request()->is('admin/Services*') ||request()->is('admin/Services_orders*'))?'menu-open':'' }}    ">
              ...
              <ul class="nav nav-treeview  ">
               <li class="nav-item">
                  <a href="" class="nav-link {{ (request()->is('admin/Services*')  and !request()->is('admin/Services_orders*'))?'active':'' }}">
                     <p>
                  ضبط الخدمات        
                     </p>
                  </a>
               ...
               <li class="nav-item">
                  <a href="" class="nav-link {{ (request()->is('admin/Services_orders*')  )?'active':'' }}">
                     <p>
                  فواتير الخدمات        
                     </p>
                  </a>
           ...
           <li class="nav-item has-treeview {{ (request()->is('admin/FinancialReport*') || request()->is('admin/customeraccountmirror*') ||request()->is('admin/FinancialReport/delegateaccountmirror') )?'menu-open':'' }}     ">
              ...
              <ul class="nav nav-treeview">
               ...
               <li class="nav-item">
                  <a href="" class="nav-link {{ (request()->is('admin/FinancialReport/delegateaccountmirror') )?'active':'' }}">
                     <p>
                        كشف حساب مندوب        
                     </p>
                  </a>
