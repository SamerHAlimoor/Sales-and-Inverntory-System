...
@section('content')
      ...
      <div class="card">
        ...
        <table id="example2" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <label> الصنف الاب</label> <br>
                     @if (empty($data['parent_item_name']))
                         لا يوجد أب - انه رئيسي
                     @else
            ...
            <tr>
                <td @if($data['does_has_retail_unit']==0) colspan="3"   @endif >
                   <label>   هل للصنف وحدة تجزئة ابن</label> <br>
                   @if($data['does_has_retail_unit']==1) نعم  @else  لا @endif
                </td> 
                ...
                <td>
                 ...
                 <td>
                    ...
                    {{ $data['retail_uom_qty_to_parent']*1 }}
                </td> 
              @endif
            </tr>
            ...
            <tr>
                <td @if($data['does_has_retail_unit']==0) colspan="3"   @endif >
                   <label>   هل للصنف وحدة تجزئة ابن</label> <br>
                   @if($data['does_has_retail_unit']==0) نعم  @else  لا @endif
                </td> 
                @if($data['does_has_retail_unit']==1)
                <td>
                    <label>  وحدة القياس التجزئة</label> <br>
  ...
  {{ $data['cost_price_retail']*1 }} 
                ...
                <td colspan="2">
                    كمية الصنف الحالية (  {{ $data['all_qty']*1  }} {{ $data['Uom_name']  }})
            ...
            <tr>
                <td>
                   ...
                   @if($data['has_fixed_price']==0) نعم  @else  لا @endif
                </td> 
                <td colspan="2">
