...
use App\Models\AdminsTreasuries;
...
class AdminsController extends Controller
{
    ...
    public function details($id)
    {
        try {
            ...
            $treasuries = get_cols_where(new Treasury(), array("id", "name"), array("active" => 0, "com_code" => $com_code), 'id', 'ASC');
            $admins_treasuries = get_cols_where(new AdminsTreasuries(), array("*"), array("admin_id" => $id, 'com_code' => $com_code), 'id', 'DESC');
    ...
    public function Add_treasuries_To_Admin($id, Request $request)
    {
        try {
            ...
            //check if not exists
            $admins_treasuries_exsits = get_cols_where_row(new AdminsTreasuries(), array("id"), array("admin_id" => $id, "treasuries_id" => $request->treasuries_id, 'com_code' => $com_code));
            ...
            $flag = insert(new AdminsTreasuries(), $data_insert);
            if ($flag) {
