...
class CustomersController extends Controller
{
    ...
    public function store(CustomerRequest $request)
    {
        ...
        try {
            ...
            $data_insert['phone'] = $request->phone ? $request->phone : null;
            ...
            if ($flag) {
                ...
                $customer_parent_account_number = get_field_value(new AdminPannelSetting(), "customer_parent_account_number", array('com_code' => $com_code));
