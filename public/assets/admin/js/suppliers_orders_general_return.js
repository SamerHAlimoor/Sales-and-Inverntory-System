$(document).ready(function () {
    ...
    $(document).on("change", "#inv_itemcard_batches_autoserial", function (e) {
        ...
        if (inv_itemcard_batches_autoserial != "") {
            var Batchunitprice = $(
                "#inv_itemcard_batches_autoserial option:selected"
            ).data("price");
    ...
    $(document).on("click", "#AddItemToIvoiceDetailsActive", function (e) {
        ...
        var inv_itemcard_batches_autoserial = $(
    ...
    $(document).on("input", "#discount_percent", function (e) {
        ...
        if (discount_type == 1) {
            if (discount_percent > 100) {
                alert(
                    "عفوا لايمكن ان يكون نسبة الخصم المئوية اكبر من 100 % !!!"
                );
    ...
    $(document).on("input", "#what_paid", function (e) {
        ...
        if (pill_type == 1) {
            ...
            if (what_paid < total_cost) {
                alert(
                    "عفوا يجب ان يكون المبلغ كاملا مدفوع في حالة ان الفاتورة كاش"
                );
            ...
            if (what_paid == total_cost) {
                alert(
                    "عفوا يجب ان لايكون كل المبلغ  مدفوع في حالة ان الفاتورة اجل"
                );
                $("#what_paid").val(0);
            }
        }
        ...
        if (what_paid > total_cost) {
            alert(
                "عفوا لايمكن ان يكون المبلغ المدفوع اكبر من  اجمالي الفاتورة"
            );
            $("#what_paid").val(0);
        }
    ...
    $(document).on("click", "#do_close_approve_invoice_now", function (e) {
        ...
        if (discount_type == 1) {
            ...
            if (parseFloat(discount_value) > parseFloat(total_befor_discount)) {
                alert(
                    "عفوا لايمكن ان يكون قيمة الخصم اكبر من اجمالي الفاتورة قبل الخصم   !!!"
                );
            ...
            if (discount_value > 0) {
                alert(
                    " عفوا لايمكن ان يوجد خصم مع اختيارك لنوع الخصم لايوجد  !!!"
                );
                $("#discount_value").focus();
                return false;
            }
        ...
        if (parseFloat(what_paid) > parseFloat(total_cost)) {
            alert(
                "عفوا لايمكن ان يكون المبلغ المصروف اكبر من اجمالي الفاتورة         "
            );
            return false;
        }
        ...
        if (pill_type == 1) {
            if (what_paid < total_cost) {
                alert(
                    "عفوا يجب ان يكون كل المبلغ مدفوع في حالة ان الفاتورة كاش       "
                );
                return false;
            }
        } else {
            if (parseFloat(what_paid) == parseFloat(total_cost)) {
                alert(
                    "عفوا لايمكن ان يكون المبلغ المدفوع يساوي اجمالي الفاتورة في حالة ان الفاتورة اجل      "
                );
                return false;
            }
        }
        ...
        if (pill_type == 1) {
            if (what_remain > 0) {
                alert(
                    "عفوا لايمكن ان يكون المبلغ المتبقي اكبر من الصفر في حالة ان الفاتورة كاش      "
                );
                return false;
            }
        }
